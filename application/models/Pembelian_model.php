...
class Pembelian_model extends CI_Model {
    ...
    function detail($id_transaksi) {
        ...
        $this->db->select('transaksi.*,header_transaksi.nama,header_transaksi.email,header_transaksi.alamat, header_transaksi.telepon, header_transaksi.nama_bank,header_transaksi.rekening_pelanggan,header_transaksi.rekening_pembayaran,header_transaksi.status,header_transaksi.bukti_bayar');
        $this->db->from('transaksi');
        $this->db->join('header_transaksi', 'header_transaksi.id_transaksi = transaksi.id_transaksi', 'left');
        $this->db->order_by('id_transaksi', 'desc');
        $query = $this->db->get();
