...
<link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/templates/css/custom.css">
<!--===============================================================================================-->
</head>
    ...
    <div class="container-menu-header">
        <div class="topbar">
            ...
            <div class="topbar-social">
                <a href="<?= $site->email ?>" target="_blank" class="topbar-social-item fa fa-envelope"></a>
                ...
                <a href="<?= $site->whatsapp ?>" target="_blank" class="topbar-social-item fa fa-whatsapp"></a>
            </div>
    ...
    <!-- Logo moblie -->
        ...
        <div class="btn-show-menu">
                ...
                <div class="header-icons-mobile">
                    ...
                    <div class="btn-show-menu-mobile hamburger hamburger--squeeze top-menu">
                    <span class="hamburger-box top-menu">
                        <span class="hamburger-inner top-menu"></span>
                    </span>
                    </div>
            ...
            <ul class="main-menu">
                ...
                <li class="item-topbar-mobile p-l-10">
                    <div class="topbar-social-mobile">
                        ...
                        <a href="<?= $site->whatsapp ?>" class="topbar-social-item fa fa-whatsapp"></a>
                    </div>
                </li>
